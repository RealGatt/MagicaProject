...
public class SpeedUpgradeItem implements Craftable, UpgradeItem {
	...
	public static ItemStack getStaticCraftedItem() {
		...
		upgrade.setDurability((short)2);
		ItemMeta im = upgrade.getItemMeta();
		im.setDisplayName(BaseUtils.colorString("&7Upgrade: &bSpeed"));
		im.addItemFlags(ItemFlag.values());
		im.addEnchant(Enchantment.DURABILITY, 1, false);
		im.setLore(Arrays.asList(BaseUtils.colorString("&7A Speed Upgrade for certain &9MagicaBlocks."),
